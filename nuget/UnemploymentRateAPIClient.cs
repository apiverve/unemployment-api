...
namespace APIVerve.API.UnemploymentRate
{
    ...
    /// <summary>
    /// Client for the UnemploymentRate API
    /// </summary>
    public class UnemploymentRateAPIClient
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/unemployment";
        ...
        private static readonly Dictionary<string, ValidationRule> _validationRules = new Dictionary<string, ValidationRule>
        {
            ...
            { "year", new ValidationRule { Type = "integer", Required = false, Min = 1991, Max = 2030 } }
        };
        ...
        public UnemploymentRateAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public UnemploymentRateAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public UnemploymentRateAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, UnemploymentRateQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(UnemploymentRateQueryOptions options)
        {
        ...
        public ResponseObj Execute(UnemploymentRateQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(UnemploymentRateQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(UnemploymentRateQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(UnemploymentRateQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(UnemploymentRateQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(UnemploymentRateQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(UnemploymentRateQueryOptions options)
        {
