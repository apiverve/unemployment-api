...
```gradle
dependencies {
    implementation 'com.github.apiverve:unemployment-api:1.1.14'
}
```
...
```java
import com.apiverve.unemployment.UnemploymentRateAPIClient;
import com.apiverve.unemployment.APIResponse;
import com.apiverve.unemployment.APIException;

// Initialize the client
UnemploymentRateAPIClient client = new UnemploymentRateAPIClient("YOUR_API_KEY");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/unemployment](https://docs.apiverve.com/ref/unemployment)
...
- **Documentation:** [https://docs.apiverve.com/ref/unemployment](https://docs.apiverve.com/ref/unemployment)
- **Issues:** [GitHub Issues](https://github.com/apiverve/unemployment-api/issues)
